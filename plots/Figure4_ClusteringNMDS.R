...
CLUSTERPLOT <- plot_grid(DendTurnPLOT, NMDSplot, align="v", rel_widths=c(1,1), labels = c('','c'))
CLUSTERPLOT
...
FullNewPlotGrid <- DendroPLOT + TurnoverPLOT + NMDSplot +
  plot_layout(
    design="
    AACC
    AACC
...
ggsave("plots/exports/Figure4_ClusteringNMDS_v4.pdf", FullNewPlotGrid, width=12, height=6)
